...
async def display_welcome_screen():
    ...
    print("  ║                                      ║")
    print("  ║     PHAROS TESTNET AUTOMATION        ║") # Mengubah ini
...
class SocialTipBot:
    def __init__(self) -> None:
        ...
        self.contract_abi = [
            ...
            {"inputs":[{"components":[{"internalType":"uint32","name":"tokenType","name":"uint32"},{"internalType":"address","name":"tokenAddress","type":"address"}],"internalType":"struct TipToken","name":"token","type":"tuple"},{"components":[{"internalType":"string","name":"idSource","type":"string"},{"internalType":"string","name":"id","type":"string"},{"internalType":"uint256","name":"amount","type":"uint256"},{"internalType":"uint256[]","name":"nftIds","type":"uint256[]"}],"internalType":"struct TipRecipientInfo[]","name":"recipients","type":"tuple[]"}],"name":"tipBatch","outputs":[],"stateMutability":"payable","type":"function"},
